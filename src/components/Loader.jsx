...
const Loader = ({
  ...
  satelliteData = null, // ← Add this prop
  isLoadingSatellites = false, // ← Add this prop
  onAddSatellite = null,
}) => {
  ...
  return (
    <div
      className={`loader-container ${isPanelOpen ? "paused" : ""}`}
      onClick={handleClick}
    >
      <div className="svg-frame" ref={frameRef}>
        {/* Base */}
        <svg style={{ "--i": 0 }}>
          <g id="big-outter">
            <g id="squares">
          ...
          <g id="big-centro">
            ...
            <g id="Ellipse-30">
              <mask id="path-26-inside-11_115_2" fill="white">
                <path d="M80.0639 287.513C88.7706 307.608 101.547 325.681 117.588 340.592L119.747 338.270C104.026 323.658 91.5052 305.946 82.9726 286.252L80.0639 287.513Z" />
              </mask>
              <path
                d="M80.0639 287.513C88.7706 307.608 101.547 325.681 117.588 340.592L119.747 338.270C104.026 323.658 91.5052 305.946 82.9726 286.252L80.0639 287.513Z"
                stroke="#00AAFF"
                strokeWidth="4"
            ...
            <g id="Ellipse-47">
              <mask id="path-29-inside-14_115_2" fill="white">
                <path d="M90.923 321.469C106.609 343.562 127.42 361.52 151.572 373.802L159.476 358.260C137.838 347.256 119.194 331.168 105.141 311.375L90.923 321.469Z" />
              </mask>
              <path
                d="M90.923 321.469C106.609 343.562 127.42 361.52 151.572 373.802L159.476 358.260C137.838 347.256 119.194 331.168 105.141 311.375L90.923 321.469Z"
                fill="#00AAFF"
                stroke="#00AAFF"
                strokeWidth="4"
          ...
          <g id="solo-lines">
            ...
            <g id="right-line">
              <mask id="path-19-inside-5_115_2" fill="white">
                <path d="M293.127 56.0696C319.474 66.6482 342.971 83.2599 361.731 104.57C380.491 125.88 393.99 151.293 401.144 178.768C408.298 206.243 408.906 235.013 402.920 262.766C396.935 290.518 384.522 316.48 366.680 338.564L365.455 337.574C383.143 315.682 395.448 289.946 401.381 262.434C407.315 234.922 406.712 206.401 399.621 179.165C392.529 151.928 379.147 126.735 360.550 105.61C341.952 84.485 318.659 68.0173 292.541 57.5306L293.127 56.0696Z" />
              </mask>
              <path
          ...
          <g id="outter-center">
            ...
            <g id="Ellipse-34">
              <mask id="path-14-inside-3_115_2" fill="white">
                <path d="M356.914 241.429C359.846 218.667 356.816 195.533 348.120 174.294L341.756 176.899C350.001 197.036 352.874 218.969 350.094 240.551L356.914 241.429Z" />
              </mask>
              <path
                d="M356.914 241.429C359.846 218.667 356.816 195.533 348.120 174.294L341.756 176.899C350.001 197.036 352.874 218.969 350.094 240.551L356.914 241.429Z"
                fill="#00AAFF"
                stroke="#00AAFF"
                strokeWidth="4"
        ...
        <svg style={{ "--i": 5 }}>
          <g id="center">
            <path
              id="center_2"
              d="M173.051 160.818C183.357 152.33 195.57 146.47 208.64 143.741L209.406 147.646L209.598 148.626L210.579 148.435C213.252 147.913 215.974 147.53 218.739 147.291C202.333 148.709 187.389 155.238 175.508 165.278L176.271 164.633L175.626 163.869L173.051 160.818ZM268.968 159.114L271.131 155.768C282.255 163.153 291.420 173.128 297.840 184.836L294.328 186.706L293.445 187.177L293.916 188.060C298.136 195.966 301.026 204.69 302.286 213.934C297.387 178 267.858 149.902 231.266 147.211C244.593 148.191 256.981 152.541 267.584 159.411L268.424 159.955L268.968 159.114ZM300.731 247.009L304.553 248.100C300.733 260.894 293.865 272.57 284.539 282.125L281.715 279.301L281.008 278.594L280.301 279.301C292.512 267.089 300.668 250.821 302.572 232.692C302.101 237.178 301.247 241.55 300.044 245.774L299.770 246.735L300.731 247.009ZM225.346 303.006L225.389 307C212.037 306.982 198.888 303.723 187.073 297.504L188.969 294.006L189.445 293.128L188.567 292.651C186.556 291.559 184.599 290.380 182.700 289.120C194.964 297.259 209.678 302 225.500 302C225.779 302 226.057 301.998 226.335 301.996L225.335 302.006L225.346 303.006ZM149.854 245.575L146.040 246.690C142.449 233.830 142.033 220.290 144.827 207.234L148.705 208.113L149.682 208.335L149.902 207.358C152.935 193.924 159.459 181.810 168.471 172.022C155.761 185.826 148 204.257 148 224.500C148 242.991 154.476 259.969 165.283 273.291C158.889 265.410 154.012 256.249 151.095 246.254L150.814 245.294L149.854 245.575Z"
              fill="#00AAFF"
              stroke="#00AAFF"
              strokeWidth="2"
            />
      ...
      <ControlPanel
        ...
        onAddSatellite={onAddSatellite} // forward to panel
